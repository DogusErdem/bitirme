...
const style= StyleSheet.create({
  ...
  button:{marginTop:15,backgroundColor:'#ff0000',paddingVertical:18,borderRadius:10,borderColor:'#B0B0C3',borderWidth:1,alignItems:'center',justifyContent:'center'},
